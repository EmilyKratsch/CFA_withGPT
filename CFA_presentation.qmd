---
title: "HDFS: Person-Centered Methods:"
author: "Emily Kratsch"
format: 
  revealjs: 
    footer: Lecture 1 (FAU)          CFA - Lecture 1          Penn State 2024
    transition: slide
    font-scale: 0.2  # Reduce overall font size for the entire presentation
editor: visual
editor_options: 
...
![](CFA_Bild_dis.png) (CFA_Bild_läuf.png) {width="121"}
